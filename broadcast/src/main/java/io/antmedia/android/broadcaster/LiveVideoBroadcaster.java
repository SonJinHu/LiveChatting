...
public class LiveVideoBroadcaster extends Service implements ILiveVideoBroadcaster, CameraHandler.ICameraViewer {
    ...
    public void pause() {
        ...
        //camera function is called after release exception may be thrown especially in htc one x 4.4.2
